...
if __name__ == "__main__":
    ...
    for i in range(8):
        ...
        train_acc_ = []
        test_acc_ = []
        log_file = open(f"training_log_fold_{i}.txt", "a")
        ...
        for epoch in range(opt.num_epochs):
            ...
            log_file.write(
                f'[Epoch: {epoch + 1}/{opt.num_epochs}] Training Loss: {train_loss_[epoch]:.3f}, Testing Loss: {test_loss_[epoch]:.3f}, Training Acc: {train_acc_[epoch]:.3f}, Testing Acc: {test_acc_[epoch]:.3f}\n')
