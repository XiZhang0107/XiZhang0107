...
from CNN_Transformer_generator import ParallelCNNTransformer, Transformer_seq2seq
...
parser.add_argument('--b1', type=int, default=9)
...
generator_file = 'Transformer_generator_seqlen_50_embed_128_epoch_59.pkl'#gggg
...
binary_clf_file = 'saved_model/'+'Transformer_datasetlen_'+str(seqlen)+'_fold_7_clf.pkl'#gggg
...
transformer_model = ParallelCNNTransformer(d_model=lyc2vec*2, nhead=16, num_encoder_layers=12, num_decoder_layers=12, batch_first=True)
